...
export class GenerateCvPdfService {
  ...
  exportAsPDF(data: PdfCVData) {
    ...
    const myImage = "https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjB8fHByb2ZpbGV8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60";
    ...
    doc.text("UNIVERSIDAD GENTLEMAN PROGRAMMING - PERÚ", 70, 50);
    doc.text("- APASIONADO DEL DESARROLLO WEB -", 70, 60);
    ...
    doc.save(name + '_export_' + new Date().getTime() + '.pdf');
}
}
