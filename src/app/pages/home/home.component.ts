...
export class HomeComponent implements AfterViewInit {
    ...
    constructor(private attendanceService: AttendanceService, private toastrService: ToastrService) {}
    ...
    getDataWeeks(currentDate: string, listHistoryStatusAttendance: StatusAttendance[]): void {
        ...
        this.lastWeek = listHistoryStatusAttendance.slice(this.dayOfWeek, this.dayOfWeek + this.totalDaysOfWeek).reverse();

        this.restDaysOfWeek = Util.getRestDaysOfWeek(this.currrentWeek.at(-1), this.dayOfWeek);
    }
