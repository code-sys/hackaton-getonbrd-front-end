...
export class UserOptionsComponent implements OnInit {
    ...
    createUserOptionsForm(): void {
        this.userOptionsForm = this.fb.group({
            ...
            notifications: new FormControl(this.themeService.getLocalStorageItem('notificaciones')),
    ...
    shouldInstall(): boolean {
        return !window.matchMedia('(display-mode: standalone)').matches && this.themeService.getInstallPwa;
    }
